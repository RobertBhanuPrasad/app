...
const Home = () => {
  ...
  return (
      <>
          ...
          <CustomCard title="Entity Configuration" description="Register your module/country/organization with CAPS (or edit the configuration if it's already registered)" content={<Button variant={"default"} onClick={()=>router.push('/caps/entity-configuration')}> Click Here</Button>} />
      </>
  )
}
