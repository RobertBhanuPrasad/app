...
export default function index() {
  ...
  const handleTabClick = value => {
    ...
    const section = document.getElementById(tabTriggers.find(trigger => trigger.value === value).id)
    if (section) {
        ...
        >
          <TabsList className="flex flex-row gap-10 !flex-start !justify-start !bg-[white] !rounded-none">
            {tabTriggers.map((trigger: any, index: any) => (
              <TabsTrigger
                ...
                isActive={selectedTab === trigger.value ? true : false}
              >
          ...
          <FormProvider {...methods}>
            ...
            <div className="flex justify-center gap-4">
              ...
              <div>
                <Button className="bg-[#7677F4] w-[86px] h-[46px] rounded-[12px] " onClick={handleSubmit(onSubmit)}>
                  Save
                </Button>
              </div>
            </div>
