          ...
          {courseData?.data?.status_id?.id !== coursePendingReviewStatusId && (
            <div className="flex flex-row gap-2 items-center">
              ...
              <HoverCard>
                ...
                <HoverCardContent>
                  <div className="w-[231px] text-wrap !rounded-[15px] font-normal">
                    {t('course.view_course:basic_details_tab.revenue_from_confirmed_pending_transaction')}{' '}
...
const PendingCourseAccountingFormApprovalDropDown = ({ courseId }: { courseId: number }) => {
  ...
  const approveCourseAccountingForm = async () => {
    await supabase.from('program').update({ program_accounting_status_id: accountingClosedStatusId }).eq('id', courseId)
