...
interface CountryConfigDataBaseType {
  ...
  localization_country_support_email_address?: string
  localization_currency_settings?: any
  localization_date_time_settings?: localizationDateTimeSettingsDataBaseType
  localization_default_language?: localizationLanguagesDataBaseType[]
  localization_fee_display?: string
  localization_have_special_code?: boolean
  organization_code?: string
  organization_id?: number
  organization_name?: string
  response_code?: string
  response_message?: string
  localization_available_languages?: localizationLanguagesDataBaseType[]
  localization_health_settings?: localizationHealthSettingsDataBaseType[]
  questions?: questionsDataBaseType[]
  localization_personal_details?: localizationPersonalDetailsDataBaseType[]
  hx_pkey?: number
  communication_preference?: boolean
  gender?: Array<{ [key: string]: string }>
  identification_type?: Array<{ [key: string]: string }>
}

interface localizationPersonalDetailsDataBaseType {
  id?: number
  order?: number
  is_active?: boolean
  created_at?: Date
...
interface questionsDataBaseType {
  question_text?: string
  question_values?: string[]
}

interface localizationHealthSettingsDataBaseType {
  id: number
  type: number
}

interface localizationLanguagesDataBaseType {
  id?: number
  code?: string
  language?: string
}

interface localizationDateTimeSettingsDataBaseType {
  default_timezone?: string
  display_date_time_format?: string
}

interface localizationCurrencySettingsDataBaseType {
  default_cuurency?: string
  decimal_demiliter?: string
  thousands_separtor?: string
}
