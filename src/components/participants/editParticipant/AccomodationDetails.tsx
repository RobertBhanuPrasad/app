...
export default function AccomodationDetails() {
  ...
  return (
    <div id="Accomodation">
      <Text className="font-semibold text-[18px] py-[25px]">Accomodation Details</Text>
      <div className="flex gap-4">
        <div className="text-[#999999] gap-2">
          ...
          <div className="py-[5px]">
            ...
            <Select disabled={true} value={accommodation_type_id}>
              ...
              <SelectContent>
                <SelectItems>
                  {accommodationOptions?.data?.map((option: any, index: number) => (
                    <>
                      <SelectItem
        ...
        <div className="w-[303px] ">
          ...
          <Text className="py-[5px] font-semibold">
            {FormData?.currency_code ? FormData?.currency_code : ''} {accommodation_fee ? accommodation_fee : '-'}
          </Text>
        </div>
        <div className="text-[#999999] ">
          <Text className="text-[#999999] text-[14px]">Roommate Preferences 1</Text>
          <Input
            value={roommate_preferences_1 ? roommate_preferences_1 : '-'}
      ...
      <div className="flex gap-6 py-[10px]">
        <div className="text-[#999999] ">
          ...
          <Input
            value={roommate_preferences_2 ? roommate_preferences_2 : '-'}
            className="w-[278px] !h-[40px] resize-none py-[5px]"
          />
        </div>
        <div className="text-[#999999] ">
          ...
          <Input
            value={roommate_preferences_3 ? roommate_preferences_3 : '-'}
            className="w-[278px] !h-[40px] resize-none py-[5px]"
          />
        </div>
      ...
      <div className="text-[#999999] py-[10px]">
        ...
        <RadioGroup value={roommate_snore} onValueChange={value => roomateSnoreChange(value)}>
          <div className="flex flex-row gap-6 ">
            <RadioButtonCard
