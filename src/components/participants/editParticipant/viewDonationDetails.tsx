    ...
    <div>
      <div>
          ...
          <div className="flex flex-col gap-4 py-[20px]">
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {donationData?.data[0]?.participant_id?.organisation_id?.name
                    ? donationData?.data[0]?.participant_id?.organisation_id
                        ?.name
                    : "-"}
                </Text>
              </div>
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {donationData?.data[0]?.participant_id?.donation_type?.value
                    ? donationData?.data[0]?.participant_id?.donation_type
                        ?.value
                    : "-"}
                </Text>
              </div>
            ...
            <div className="flex pr-[20px]">
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {donationData?.data[0]?.participant_id?.transaction_type
                    ?.value
                    ? donationData?.data[0]?.participant_id?.transaction_type
                        ?.value
                    : "-"}
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {donationData?.data[0]?.payment_transaction_id
                    ? donationData?.data[0]?.payment_transaction_id
                    : "-"}
                </Text>
              </div>
          ...
          <div className="flex flex-col gap-4 py-[20px]">
            <div className="flex pr-[20px]">
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {contactData?.data?.contact_id?.date_of_birth
                    ? formatDateString(
                        new Date(contactData?.data?.contact_id?.date_of_birth)
                      )
                    : "-"}
                </Text>
              </div>
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {contactData?.data?.contact_id?.street_address
                    ? contactData?.data?.contact_id?.street_address
                    : "-"}
                </Text>
              </div>
            ...
            <div className="flex pr-[20px]">
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {contactData?.data?.contact_id?.state_id?.name
                    ? contactData?.data?.contact_id?.state_id?.name
                    : "-"}
                </Text>
              </div>
              ...
              <div className="w-[225px]">
                ...
                <Text className="font-semibold text-[#666666] text-[16px]">
                  {contactData?.data?.contact_id?.city_id?.name
                    ? contactData?.data?.contact_id?.city_id?.name
                    : "-"}
                </Text>
              </div>
            ...
            <div className="flex pr-[20px]">
              ...
              <div className="w-[225px]">
                <Text className="text-[#999999] text-[16px]">
                  {contactData?.data?.contact_id?.identification_type_id
                    ?.value ??
                    contactData?.data?.contact_id?.identification_type_id
                      ?.value}
                </Text>
        ...
        <div className="flex justify-center">
          <Button onClick={() => setViewDonation(false)}>Close</Button>
        </div>
      </div>
    </div>
  );
