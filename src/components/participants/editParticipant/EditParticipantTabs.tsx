  ...
  let tabs = [
    {
      ...
      content: (
        <div>
          <ParticipantInformation activeTabValue={activeTabValue}/>
        </div>
      ),
      value: EDIT_PARTICIPANT_INFORMATION
    },
    {
      id: 1,
      label: 'Course Fees',
      content: (
        <div>
          <CourseFee activeTabValue={activeTabValue}/>
        </div>
      ),
      value: EDIT_PARTICIPANT_COURSE_FEE
    },
    {
      id: 2,
      ...
      content: (
        <div>
          <AccomodationDetails activeTabValue={activeTabValue} />
        </div>
      ),
      value: EDIT_PARTICIPANT_ACCOMODATION_DETAILS
    },
    {
      id: 3,
      ...
      content: (
        <div>
          <PaymentDetails activeTabValue={activeTabValue}/>
        </div>
      ),
      value: EDIT_PARTICIPANT_PAYMENT_DETAILS
    },
    {
      id: 4,
    ...
    },
    {
      ...
      content: (
        <div>
          <ViewParticipantUtmParameters participantId={Id} activeTabValue={activeTabValue}/>
        </div>
      ),
