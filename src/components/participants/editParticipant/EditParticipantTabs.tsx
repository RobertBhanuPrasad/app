  ...
  let tabs = [
    {
      ...
      content: (
        <div>
          <ParticipantInformation activeTab={activeTab}/>
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <div>
          <AccomodationDetails activeTab={activeTab}/>
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <div>
          <ViewParticipantUtmParameters participantId={Id} activeTab={activeTab}/>
        </div>
      )
    }
  ]
