...
export default function NewCourseReviewPage() {
  ...
  const VenueData = [VenueName, VenueAddress, CityNames, StateNames, VenuePostalCode].join(', ')
  ...
  return (
    <div className="pb-12">
      <div className="text-[24px] my-4 font-semibold">Review Your Details</div>
      <div className="w-full p-6 text-base bg-white shadow-sm max-h-fit rounded-3xl">
        ...
        <section className="w-full py-8 text-base border-b">
          ...
          {programTypeData?.data?.is_online_program === true ? (
            ...
            <div className="grid grid-cols-4 gap-4 mt-2">
              <div className=" min-w-72">
                <p className="text-sm font-normal text-accent-light text-[#999999]">Venue Address</p>
                <abbr
                  className="font-semibold truncate block no-underline text-accent-secondary text-[#666666]"
