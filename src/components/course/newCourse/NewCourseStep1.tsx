...
const RegistrationGateway = () => {
    ...
    return (
        <div className="flex flex-row gap-6 mt-[60px]">
            ...
            {value && (
                <div className="flex flex-col gap-1 ml-8 -mt-7">
            ...
            <div className="flex flex-row items-center gap-7">
                ...
                >
                    <RadioGroupCheckItem
                        ...
                        id={iAmOrganizerId}
                        className={
                            value === iAmOrganizerId ? "!bg-[#7677F4] !border-none " : "!border-[#D6D7D8] !shadow-none "
                        }
                    />
...
const OrganizationDropDown = () => {
    ...
    console.log("data is", options, value);
    ...
    return (
        <div className="h-20 w-80">
            <div className="flex flex-col gap-1">
                ...
                {errors.organization && <span className="text-[#FF6D6D] text-[12px]">Select Organizer Name.</span>}
            </div>
        </div>
    );
};
