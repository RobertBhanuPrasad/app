...
export default function NewCourseReviewPage() {
    ...
    const programOrganizedBy = getOptionValueObjectById(
        PROGRAM_ORGANIZER_TYPE,
        formData?.programOrganizedBy
    );
    const organization = getOptionValueObjectById(
        PROGRAM_ORGANIZER_TYPE,
            ...
            <section className="w-full py-8 text-base border-b">
                ...
                <div className="grid grid-cols-3 gap-4 mt-2">
                    <div className=" min-w-72">
                        ...
                        <p className="font-semibold truncate text-accent-secondary">
                            2118 Thornridge Cir. Syracuse, Connecticut, Kentucky
                            35624
                        </p>
                    </div>
                    <div className=" min-w-72">
                    ...
                    <div className=" min-w-72">
                        ...
                        <p className="font-semibold truncate text-accent-secondary">
                            08 Feb, 2024 |09:00 am to 12:00 pm 08 Feb, 2024
                            |03:00 pm to 06:00 pm 09 Feb, 2024 |09:00 am to
                            12:00 pm 09 Feb, 2024 |09:00 am to 12:00 pm
                        </p>
                    </div>
                </div>
            </section>
