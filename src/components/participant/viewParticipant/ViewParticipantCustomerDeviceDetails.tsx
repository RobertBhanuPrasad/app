...
function ViewParticipantCustomerDeviceDetails({ participantId,activeTab }: any) {
  const query: any = {
  ...
  return (
    <div>
      <p className={`text-[18px] font-[600]  ${activeTab==VIEW_CUSTOMER_DEVICE_DETAILS?'text-[#7677F4]':'text-[#333333]'}`}>Customer Device Details</p>
      <div>
        <BaseTable
