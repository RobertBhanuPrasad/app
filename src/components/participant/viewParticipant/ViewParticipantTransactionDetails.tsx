            ...
            <div className="flex">
                ...
                <div className="cursor-pointer">
                    <div className="text-left">
                        <TransactionActivity
                            transactionHistory={
                                participantTransactionDetailsData?.data?.data
                            }
...
const columns: ColumnDef<ParticipantPaymentHistoryDataBaseType>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <Text className="lowercase">{row?.original?.expense_fee}</Text>
            );
        },
    },
    {
        ...
        header: () => {
            return (
                <TableHeader className=" min-w-[100px]">Tax (EUR)</TableHeader>
            );
        },
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <Text className="lowercase">
                    {row?.original?.discounted_amount}
                </Text>
            );
        },
    },
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <Text className="lowercase">{row?.original?.total_amount}</Text>
            );
        },
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <Text className="lowercase">{row?.original?.source_text}</Text>
            );
        },
    },
    {
        ...
        header: () => {
            return (
                <TableHeader className="min-w-[120px]">Fee level</TableHeader>
            );
        },
        cell: ({ row }) => {
            return (
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <Text className="lowercase">
                    {row?.original?.transaction_reason}
                </Text>
            );
        },
    },
