...
function ViewParticipantUtmParameters({ participantId,activeTabValue }: any) {
  const query: any = {
  ...
  return (
    <div>
      <p className={` ${activeTabValue == VIEW_PARTICIPANT_UTM_PARAMETERS && 'text-[#7677F4]'} text-[18px] font-[600]`}>UTM Parameters</p>
      <div>
        <BaseTable
